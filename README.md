...
> _Fill in after your latest training run — numbers below are placeholders._

| Metric | Value |
|---|---|
| Validation accuracy | `TBD` |
| Validation top-3 accuracy | `TBD` |
...
This started as a team project (originally a single Kaggle notebook). This
repository is a personal fork that I reorganized into a proper Python
package — modularized by responsibility, made paths configurable, fixed a
couple of bugs from the original notebook, and added tests — and that I
